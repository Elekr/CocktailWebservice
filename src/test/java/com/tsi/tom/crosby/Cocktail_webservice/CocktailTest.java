...
public class CocktailTest {
    ...
    public void testObject()
    {
        ...
        assertEquals(cocktail2.getName() == null, true, "The value should be 'TestDrink2'");
        assertEquals(cocktail2.getCocktail_Instructions_number_of_instructions() == 0, true, "The value should be '242'");
    }
